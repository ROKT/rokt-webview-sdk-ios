#
# Be sure to run `pod lib lint RoktWebViewSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'RoktWebViewSDK'
  s.version          = '0.1.0'
  s.summary          = 'RoktWebViewSDK.'
  s.swift_version    = '5.0'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'RoktWebViewSDK' => ['RoktWebViewSDK/Assets/*.png']
  # }
